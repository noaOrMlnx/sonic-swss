    ...
    TEST_F(PortsOrchTest, PortAdvancedConfig)
    {
        ...
        std::deque<KeyOpFieldsValuesTuple> kfvList = {{
            ...
            SET_COMMAND, {
                ...
                // { "fir_pre3",    "0x8,0x9,0x10,0x11"           },
                // { "fir_pre2",    "0x2a,0x2b,0x2c,0x2d"         },
                // { "fir_pre1",    "0x3a,0x3b,0x3c,0x3c"         },
                // { "fir_main",    "0x44,0x45,0x46,0x47"         },
                // { "fir_post1",   "0x10,0x12,0x11,0x13"         },
                // { "fir_amp",     "0xfa,0xfc,0xfb,0xfd"         }
            }
        }};
